...
const CUISINES: { name: string; description: string; icon: string }[] = [
  ...
  { name: 'Malvani', description: 'Spicy Maharashtrian coastal with bold masalas', icon: '' },
  ...
  { name: 'Goan', description: 'Portuguese-influenced vindaloo and bebinca', icon: '' },
  ...
  { name: 'Rajasthani', description: 'Dal baati churma, ker sangri and desert spices', icon: '' },
  ...
  { name: 'Himachali', description: 'Sidu, chha gosht and mountain valley comfort food', icon: '' },
