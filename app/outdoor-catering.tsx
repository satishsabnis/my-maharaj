...
const HEADER_COLOR  = '#1A6B3C'; // Outdoor green theme
...
Focus on food that travels well, stays fresh outdoors, and is easy to serve without a full kitchen.
Prefer finger foods, wraps, dry snacks and heat-stable dishes where appropriate.
...
Include 3-5 items per section. Make packing_tips specific to outdoor serving.`;
    ...
    try {
      ...
      setMenu(JSON.parse(clean) as OutdoorMenu);
      setStep('result');
    } catch (e) {
          ...
          <View style={s.container}>
            ...
            >
              {loading
                ...
                : <Text style={s.generateBtnText}>🏕️ Generate Outdoor Menu</Text>
              }
            </TouchableOpacity>
          </View>
        </ScrollView>
          ...
          <View style={s.container}>
            ...
            <View style={s.resultHeader}>
              ...
              <Text style={s.resultMeta}>
                {guests} guests · {foodType} · {setup} · AED {budget}/head
              </Text>
