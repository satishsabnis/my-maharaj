...
const dishes = [
  ...
  V('Biryani Vegetable Hyderabadi','वेजिटेबल बिरयानी',null,'Mixed vegetables and basmati cooked under dum with saffron and Hyderabadi spice masala.',[HY],S,['lunch_curry'],false,false,false,null),
  ...
  V('Dali Bara','दाली बड़ा',null,'Crispy deep-fried urad and chana dal fritters served with chutneys — a popular Odia morning street snack.',[OD],E,['breakfast'],false,false,true,null),
  ...
  NV('Chicken Tikka Roll','चिकन टिक्का रोल',null,'Tandoor chicken tikka pieces wrapped in rumali roti with onion and mint chutney.',[],N,['snack'],'chicken'),
  NV('Egg Bhurji Pav','अंडा भुर्जी पाव',null,'Spiced scrambled egg served with buttered pav — a Mumbai street food staple.',[],W,['snack'],'egg'),
  ...
  NV('Frankies Chicken','चिकन फ्रेंकी',null,'Thin roti rolled around spiced chicken filling with onion and sauce — a Kolkata and Mumbai street wrap.',[],W,['snack'],'chicken'),
  ...
  NV('Egg Dosa','अंडा डोसा',null,'Crispy dosa with egg cracked and cooked inside — a popular street variant from Tamil Nadu.',[],S,['snack'],'egg'),
